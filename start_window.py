...
class Ui_Start_Window(object):
    def start_window_Ui(self, Start_Window):
        ...
        self.name_of_the_game_lb.setGeometry(QtCore.QRect(540, 280, 750, 250))
        font = QtGui.QFont()
        ...
        self.start_game_button.setGeometry(QtCore.QRect(720, 590, 331, 71))
        font = QtGui.QFont()
        font.setFamily("Minecraft Seven Cyrillic (russi")
        ...
        self.rules_button.setGeometry(QtCore.QRect(720, 680, 331, 71))
        font = QtGui.QFont()
        font.setFamily("Minecraft Seven Cyrillic (russi")
        font.setPointSize(28)
        font.setBold(True)
        ...
        self.shop_button.setGeometry(QtCore.QRect(720, 770, 331, 71))
        font = QtGui.QFont()
        font.setFamily("Minecraft Seven Cyrillic (russi")
        font.setPointSize(28)
        font.setBold(True)
